...
:::tip
You can find all available configuration options on the [configuration page](/advanced/configuration).
:::
...
- If you want to pull images from a private registry, you can find more information on the page [Private Registry](/advanced/private-registry).
- You can find all available configuration options on the page [Configuration](/advanced/configuration).